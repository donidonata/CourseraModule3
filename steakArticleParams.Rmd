---
title: "Steak Preferences in the US"
...
Finally, here is a breakdown of the `r nrow(sdat)` survey 
respondents for the `r params$region` region of the US on how they prefer their steak to be prepared by gender.
